...
def main() -> None:
    parser = argparse.ArgumentParser(description="Print the deployment endpoint contract for a config.")
    parser.add_argument(
        "--config",
    ...
    print(json.dumps(endpoint_contract, ensure_ascii=False, indent=2))
