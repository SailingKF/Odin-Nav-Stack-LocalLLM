...
def main() -> None:
    parser = argparse.ArgumentParser(description="Print the guided bring-up verification sheet for a config.")
    parser.add_argument(
        "--config",
    ...
    deployment_verification_manifest = build_deployment_verification_manifest(
    ...
    print(json.dumps(verification_sheet, ensure_ascii=False, indent=2))
