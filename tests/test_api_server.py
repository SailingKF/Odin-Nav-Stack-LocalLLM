...
class ApiServerTests(unittest.TestCase):
    ...
    def test_health_and_state(self) -> None:
        ...
        self.assertIn("deployment_config_hygiene", payload)
        ...
        self.assertIn("deployment_config_hygiene", health.json())
        ...
        self.assertIn("overall_hygiene_status", payload["deployment_config_hygiene"])
        self.assertIn("recommended_actions", payload["deployment_config_hygiene"])
    ...
    def test_debug_page_is_served_for_mobile_use(self) -> None:
        ...
        self.assertNotIn('value="http://127.0.0.1:8000"', response.text)
